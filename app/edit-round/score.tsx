...
export default function EditScoreScreen() {
  ...
  const [score, setScore] = useState(params.score as string || '');
  const [holes, setHoles] = useState<'18' | 'front9' | 'back9'>((params.holes as any) || '18');
  ...
  return (
    ...
    >
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Edit Round</Text>
        <View style={{ width: 28 }} />
      </View>
